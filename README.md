...
- Compatible with the [Open Charge Point Protocol (OCPP) 1.6J](https://www.openchargealliance.org/protocols/ocpp-16/) by default, while allowing Charging Stations to upgrade to newer protocols if they support them.
