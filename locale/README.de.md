...
- [API](https://de.wikipedia.org/wiki/Programmierschnittstelle)-Integration mit [Odoo](https://www.odoo.com/), synchronisierend:
  - Mitarbeiterzugänge über `res.users`
  - Den Produktkatalog über `product.product` abfragen
