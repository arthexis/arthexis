...
from apps.content.video import admin as video_admin
from apps.content.video.frame_cache import CachedFrame
from apps.content.video.models import MjpegStream, VideoDevice, VideoSnapshot, YoutubeChannel
...
def test_mjpeg_stream_action_captures_snapshot(admin_client, monkeypatch):
    ...
    monkeypatch.setattr("apps.content.video.admin.get_frame", fake_get_frame)
