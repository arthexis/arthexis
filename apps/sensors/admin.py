...
class ThermometerAdmin(admin.ModelAdmin):
    ...
    list_filter = ("kind", "alarm_enabled", "last_alarm_level", "is_active")
...
@admin.register(ThermometerAlarmEvent)
class ThermometerAlarmEventAdmin(admin.ModelAdmin):
    list_display = (
        "thermometer",
        "level",
        "reading",
