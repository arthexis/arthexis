...
ODOO_APP_INSTALLED = django_apps.is_installed("apps.odoo")
...
class CustomerAccount(Entity):
    ...
    def save(self, *args, **kwargs):
        ...
        live_subscription_product = (
            getattr(self, "live_subscription_product", None)
            if ODOO_APP_INSTALLED
            else None
        )
        if live_subscription_product and not self.live_subscription_start_date:
        ...
        if (
            ...
            self.live_subscription_next_renewal = (
                ...
                + timedelta(days=live_subscription_product.renewal_period)
            )
