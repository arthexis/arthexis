"""Action router registry for CSMS consumer handlers."""
...
class CSMSRouterContext(Protocol):
...
def build_action_registry(consumer: CSMSRouterContext) -> dict[str, Handler]:
