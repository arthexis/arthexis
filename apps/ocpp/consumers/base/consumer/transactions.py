...
class TransactionHandler:
    ...
    async def handle_transaction_event(self, payload, msg_id, raw, text_data):
    ...
    async def handle_start_transaction(self, payload, msg_id, raw, text_data):
    ...
    async def handle_stop_transaction(self, payload, msg_id, raw, text_data):
