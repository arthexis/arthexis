"""Call result handlers for certificate actions."""
...
from ... import store
from ...models import CertificateOperation, InstalledCertificate, Charger
...
async def handle_get_installed_certificate_ids_result(
    ...
    def _apply():
        ...
        for entry in entries:
            ...
            installed, created = InstalledCertificate.objects.get_or_create(
                charger=charger,
