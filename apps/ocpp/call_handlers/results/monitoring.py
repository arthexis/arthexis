"""Call result handlers for monitoring and variable actions."""
...
from ..utils import _extract_component_variable, _format_status_info
...
async def handle_set_monitoring_base_result(
    ...
    monitoring_base = metadata.get("monitoring_base") or payload_data.get("monitoringBase")
