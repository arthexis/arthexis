...
class ChargingStationAdmin(
    AuthorizationActionsMixin, OwnableAdminMixin, EntityModelAdmin
):
    ...
    def save_model(self, request, obj, form, change):
        ...
        station_fields = {
            ...
            "preferred_ocpp_version": form.cleaned_data.get(
                "preferred_ocpp_version", ""
            ),
    ...
    def fetch_station_configuration(self, request, queryset):
        ...
        return self.fetch_cp_configuration(
            request, self._station_charge_points(queryset)
        )
    ...
    def toggle_station_rfid_authentication(self, request, queryset):
        ...
        return self.toggle_rfid_authentication(
            request, self._station_charge_points(queryset)
        )
    ...
    def send_station_rfid_list_to_evcs(self, request, queryset):
        ...
        return self.send_rfid_list_to_evcs(
            request, self._station_charge_points(queryset)
        )
    ...
    def update_station_rfids_from_evcs(self, request, queryset):
        ...
        return self.update_rfids_from_evcs(
            request, self._station_charge_points(queryset)
        )
    ...
    def clear_station_authorization_cache(self, request, queryset):
        ...
        return self.clear_authorization_cache(
            request, self._station_charge_points(queryset)
        )
    ...
    def clear_station_charging_profiles(self, request, queryset):
        ...
        return self.clear_charging_profiles(
            request, self._station_charge_points(queryset)
        )
