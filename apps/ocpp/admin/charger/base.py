"""Core Charger admin wiring and shared UI behavior."""
...
class ChargerAdminBaseMixin(LogViewAdminMixin):
    """Base admin mixin containing field wiring and non-specialized actions."""
    ...
    def display_name_with_fallback(self, obj):
        """Return charger name fallback chain for list display."""
        return charger_display_name(obj)
    ...
    def _build_purge_summaries(self, queryset):
        ...
        for target in target_chargers.values():
            ...
            if summary is None:
                summary = {
                    "charger": target,
                    "display_name": charger_display_name(target),
                    "transactions": 0,
                    "meter_values": 0,
                }
                ...
                summary["display_name"] = charger_display_name(target)
