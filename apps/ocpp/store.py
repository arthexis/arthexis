...
def forward_monitoring_report(report: dict[str, object]) -> None:
    """Queue a normalized NotifyMonitoringReport payload for analytics."""

    monitoring_reports.append(dict(report))
