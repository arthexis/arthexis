...
def resolve_action(options: dict[str, object]) -> dict[str, object]:
    ...
    if subcommand == "config":
        return {
            ...
            "mode": options.get("config_action"),
    ...
    if subcommand == "enable-autostart":
        return {"name": "enable_autostart", "id_tag": options.get("id_tag")}
    if subcommand == "disable-autostart":
        return {"name": "disable_autostart"}
