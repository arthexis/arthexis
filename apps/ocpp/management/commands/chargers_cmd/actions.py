...
from .restart_guard import require_local_restart_targets
...
class ChargersActionRunner:
    ...
    def __init__(self, command):
        ...
        self._handlers = {
            ...
            "config": self._config,
            "disable_autostart": self._disable_autostart,
    ...
    def execute(
        ...
        *,
        ...
        handler(
            action=action, chargers=chargers, queryset=queryset, selection=selection
        )
    ...
    def _enable_autostart(
        ...
        *,
        ...
        self.command._require_selector(selection)
        self.command._handle_enable_autostart(
            id_tag=action.get("id_tag"), queryset=queryset
        )
    ...
    def _disable_autostart(
        ...
        *,
        ...
        self.command._require_selector(selection)
        self.command._handle_disable_autostart(queryset=queryset)
    ...
    def _config(
        ...
        *,
        ...
        self.command._require_selector(
            selection,
            message=(
                "OCPP configuration requests require selecting at least one "
                "charger with --sn, --cp, or --all."
            ),
        )
        self.command._handle_config_action(
            chargers=chargers,
            key=action.get("key"),
    ...
    def _stop(
        ...
        *,
        ...
        self.command.stdout.write(
            self.command.style.SUCCESS(
                f"Sent remote stop request to {sent} charger(s)."
            )
        )
    ...
    def _restart(
        ...
        *,
        ...
        require_local_restart_targets(restart_targets)
