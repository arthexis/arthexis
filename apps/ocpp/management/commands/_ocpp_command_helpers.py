...
def add_transactions_export_arguments(parser) -> None:
    ...
    charger_filter_group = parser.add_mutually_exclusive_group()
    charger_filter_group.add_argument(
        "--chargers",
        nargs="+",
    ...
    charger_filter_group.add_argument(
        "--all-chargers",
        action="store_true",
        help="Explicitly export all chargers. This matches omitting --chargers.",
    )
