...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        implemented_cp_to_csms = _implemented_cp_to_csms(app_dir, protocol_slug="ocpp201")
        implemented_csms_to_cp = _implemented_csms_to_cp(app_dir, protocol_slug="ocpp201")
