...
def test_consumer_includes_charging_profile_handler_mixin():
    assert ChargingProfileHandlersMixin in CSMSConsumer.__mro__
    assert (
        CSMSConsumer._handle_report_charging_profiles_action
        is ChargingProfileHandlersMixin._handle_report_charging_profiles_action
    )
