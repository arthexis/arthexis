...
@override_settings(OCPP_AUTHORIZATION_POLICY="open")
def test_resolved_authorization_policy_honors_open_global_setting():
    charger = Charger.objects.create(charger_id="CH-POLICY-OPEN")
