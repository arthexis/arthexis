"""Handlers for charging profile related call errors."""
...
from apps.ocpp.models import ChargingProfile
...
async def handle_set_charging_profile_error(
    ...
    """Handle SetChargingProfile errors."""
    parts: list[str] = []
...
async def handle_get_charging_profiles_error(
    ...
    """Handle GetChargingProfiles errors."""
    parts: list[str] = []
    if error_code:
