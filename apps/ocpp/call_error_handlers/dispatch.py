...
from .configuration import (
    ...
    handle_clear_variable_monitoring_error,
    ...
    handle_get_local_list_version_error,
    handle_get_monitoring_report_error,
    handle_get_report_error,
    handle_get_transaction_status_error,
    handle_get_variables_error,
    ...
    handle_set_variable_monitoring_error,
    handle_set_variables_error,
...
CALL_ERROR_HANDLERS: dict[str, CallErrorHandler] = MappingProxyType({
    ...
    "ClearVariableMonitoring": handle_clear_variable_monitoring_error,
    ...
    "GetLocalListVersion": handle_get_local_list_version_error,
    "GetMonitoringReport": handle_get_monitoring_report_error,
    ...
    "SetVariableMonitoring": handle_set_variable_monitoring_error,
    "SetVariables": handle_set_variables_error,
    "SendLocalList": handle_send_local_list_error,
    "GetVariables": handle_get_variables_error,
