...
- Freshly created staff accounts automatically pull in both shared and personal fixtures via signals in [`locals/user_data/signals.py`](../../locals/user_data/signals.py) so admins inherit the latest local defaults on first login.
