...
from apps.content_suite.rendering import sanitize_wiki_inline_html, strip_all_html_tags
...
class WikiSummary:
    ...
    def first_paragraph(self) -> str:
        ...
        if is_html:
            return strip_all_html_tags(paragraph)
    ...
    def first_paragraph_html(self) -> str:
        ...
        cleaned = sanitize_wiki_inline_html(paragraph)
