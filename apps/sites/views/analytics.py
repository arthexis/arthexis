...
class ClientReportForm(forms.Form):
    ...
    if OCPP_APP_INSTALLED:
        ...
        chargers = forms.MultipleChoiceField(
            label=_("Charge points"),
            choices=(),
            required=False,
            disabled=True,
            widget=forms.CheckboxSelectMultiple,
            help_text=_("Charge point reports require the OCPP app."),
        )
    ...
    def __init__(self, *args, request=None, **kwargs):
        ...
        if OCPP_APP_INSTALLED and not self.is_bound:
    ...
    def clean(self):
        ...
        if period == "range":
            ...
            try:
                ...
                raise forms.ValidationError(_("Please select a week.")) from None
            cleaned["start"] = start
