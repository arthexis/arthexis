...
class SiteModuleVisibilityInline(admin.TabularInline):
    model = SiteModuleVisibility
    extra = 0
    fields = ("module", "visibility", "audience", "is_enabled")


class SiteAdmin(DjangoSiteAdmin):
    form = SiteForm
    inlines = [SiteBadgeInline, SiteModuleVisibilityInline]
