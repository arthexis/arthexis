...
def test_nav_links_prefers_most_specific_current_module(monkeypatch):
    ...
    Landing.objects.create(module=parent, path="/alpha/home/", label="Alpha Home", enabled=True)
    Landing.objects.create(module=child, path="/alpha/beta/home/", label="Beta Home", enabled=True)
