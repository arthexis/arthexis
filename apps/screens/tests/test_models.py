...
def test_update_text_respects_refresh_rate():
    ...
    assert screen.character_buffer == "A"
    ...
    assert screen.character_buffer == "C"


def test_update_pixels_respects_refresh_rate():
    ...
    assert first is True
    assert list(screen.pixel_buffer) == [1, 0, 0, 1]
    ...
    assert third is True
    assert list(screen.pixel_buffer) == [3, 3, 3, 3]
