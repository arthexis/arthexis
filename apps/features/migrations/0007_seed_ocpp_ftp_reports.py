...
FIXTURE_PATH = (
    ...
    / "fixtures"
    / "features__ocpp_ftp_reports.json"
)
...
def _load_fixture():
    ...
    try:
        ...
        print(f"Warning: Could not load or parse fixture {FIXTURE_PATH}: {exc}")
        return []
...
def seed_ocpp_ftp_reports(apps, schema_editor):
    del schema_editor
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("features", "0006_suite_features_naming"),
    ]

    operations = [
        migrations.RunPython(seed_ocpp_ftp_reports, migrations.RunPython.noop),
    ]
