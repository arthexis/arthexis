...
def _auto_upgrade_next_check():
    from apps.core.system.upgrade import _auto_upgrade_next_check as resolver

    return resolver()


def _resolve_auto_upgrade_namespace(key: str) -> str | None:
    from apps.core.system.upgrade import _resolve_auto_upgrade_namespace as resolver

    return resolver(key)


_SYSTEM_SIGIL_NAMESPACES: dict[str, Callable[[str], str | None]] = {
