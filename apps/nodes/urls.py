...
urlpatterns = [
    ...
    path(
        "register/next-gway-number/",
        views.next_gway_number,
        name="register-next-gway-number",
    ),
    path(
        "register/proxy/",
    ...
    path(
        "migration-status/",
        views.deferred_migration_status,
        name="node-migration-status",
    ),
    ...
    path(
        "network/chargers/import/",
        views.import_chargers,
        name="node-network-import-chargers",
    ),
    path(
