...
def test_legacy_commands_removed_from_registry():
    """Legacy standalone commands should no longer be registered."""

    commands = get_commands()
    for legacy_command in ("message", "purge_nodes", "purge_net_messages", "screenshot"):
