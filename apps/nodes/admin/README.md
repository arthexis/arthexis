...
Service validation for systemd-managed components now lives in the `apps.services` app, keeping operational checks separate from
node administration.
...
- `node_manager_admin.py` — admin for `NodeManager` owner/credential management.
