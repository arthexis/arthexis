...
- Keep PR development, patchwork ownership, review loops, and merge procedures in device-local Codex skills or helper tools instead of generated suite guidance.
