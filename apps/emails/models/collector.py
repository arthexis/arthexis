...
class EmailCollector(Entity):
    ...
    def odoo_customer_fields_complete(self) -> bool:
        ...
        return bool(
            getattr(self, "odoo_customer_name", "")
            and getattr(self, "odoo_customer_address", "")
            and getattr(self, "odoo_customer_phone", "")
        )
    ...
    def _update_odoo_customer_snapshot(self, sigils: dict[str, str]) -> None:
        ...
        if not ODOO_APP_INSTALLED or not getattr(self, "odoo_profile_id", None):
            return
