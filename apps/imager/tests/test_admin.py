...
from apps.imager.admin import RaspberryPiImageBuildForm, _probe_download_url
...
def test_imager_admin_leaves_first_boot_clone_url_explicit():
    form = RaspberryPiImageBuildForm()

    assert form.fields["git_url"].initial == DEFAULT_ARTHEXIS_GIT_URL
    assert form.fields["git_url"].required is False
