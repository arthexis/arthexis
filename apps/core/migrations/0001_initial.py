    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("is_user_data", models.BooleanField(default=False, editable=False)),
                ("is_deleted", models.BooleanField(default=False, editable=False)),
                ("host", core.fields.SigilShortAutoField(max_length=255)),
                ("database", core.fields.SigilShortAutoField(max_length=255)),
                ("username", core.fields.SigilShortAutoField(max_length=255)),
                ("password", core.fields.SigilShortAutoField(max_length=255)),
                (
                    "crm",
                    models.CharField(
