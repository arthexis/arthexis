...
from django.http import JsonResponse, HttpResponseGone, HttpResponseNotAllowed
...
# Charge points upload diagnostics without a browser session, so CSRF protection
# would block legitimate device uploads.
@csrf_exempt
