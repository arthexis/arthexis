...
from .broker import resolve_redis_broker_fallback
...
CHANNEL_LAYERS, CHANNEL_LAYER_DECISION = resolve_channel_layers(
    ...
    shared_backend_required=role_requires_shared_channel_layer(
        os.environ.get("NODE_ROLE", "Terminal")
    ),
)
