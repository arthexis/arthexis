...
| `apps.nodes` | `/nodes/network/chargers/`, `/nodes/network/chargers/import/`, `/nodes/network/chargers/action/` | Documented (current state) | Signed peer sync and delegated charger control are documented. |
