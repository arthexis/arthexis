...
Markdown sources are rendered into Kindle-friendly plain text during generation.
The generated `.txt` file should not expose heading markers, fenced-code markers,
or Markdown link syntax to the reader.
