...
* ✅ Stage 2 – Energy session query: Relay-style `energySessions` connection
  exposes transaction data with filters, pagination, and meter readings covered
  by tests aligning resolver output with `Transaction.kw` behavior.
