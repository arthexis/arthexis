...
The skill directly operationalizes the attack families and resilience scorecard documented in the Watchtower internet attack simulation playbook, so both human-led and Codex-led drills follow the same control objectives.
