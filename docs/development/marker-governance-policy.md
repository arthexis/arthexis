...
- Record marker promotions/demotions in a dated ledger file under `docs/development/testing/archive/`.
...
- [`docs/development/testing/archive/`](testing/archive/index.md)
