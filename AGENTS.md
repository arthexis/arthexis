...
- When Django generates migrations that import callables from `apps.<app>.models`, rewrite them to use `import_callable` pointing at the corresponding `migration_utils` helper and supply aliases for legacy paths.
