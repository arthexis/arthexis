# Generated by Django 5.2.4 on 2025-09-04 02:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, help_text='Designates whether this user should be treated as active. Unselect this instead of deleting energy accounts.', verbose_name='active')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('footer_visibility', models.CharField(choices=[('public', 'Public'), ('private', 'Private'), ('staff', 'Staff')], default='public', max_length=7, verbose_name='Footer visibility')),
                ('transaction_uuid', models.UUIDField(db_index=True, default=uuid.uuid4)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='references', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='energy_account', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_seed_data', models.BooleanField(default=False, editable=False)),
                ('is_deleted', models.BooleanField(default=False, editable=False)),
                ('amount_kw', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Energy (kW)')),
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='credits', to='core.energyaccount')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_deleted', models.BooleanField(default=False, editable=False)),
                ('name', models.CharField(max_length=100)),
                ('brand', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ev_models', to='core.brand')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference', models.ForeignKey(blank=True, help_text='Optional reference for this RFID.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='rfids', to='core.reference')),
            ],
            options={
                'verbose_name': 'RFID',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.energyaccount')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='vehicles', to='core.energyaccount')),
                ('brand', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='vehicles', to='core.brand')),
                ('model', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='vehicles', to='core.evmodel')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='admin_history', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-visited_at'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_seed_data', models.BooleanField(default=False, editable=False)),
                ('is_deleted', models.BooleanField(default=False, editable=False)),
                ('pypi_username', models.CharField(blank=True, max_length=100, verbose_name='PyPI username')),
                ('pypi_token', models.CharField(blank=True, max_length=200, verbose_name='PyPI token')),
                ...
                ('pypi_password', models.CharField(blank=True, max_length=200, verbose_name='PyPI password')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('revision', models.CharField(blank=True, default=utils.revision.get_revision, editable=False, max_length=40)),
                ('pypi_url', models.URLField(blank=True, editable=False, verbose_name='PyPI URL')),
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('package', 'version'), name='unique_package_version')],
            },
        ),
        migrations.CreateModel(
            name='OdooProfile',
