...
def activate_default_package(apps, schema_editor):
    Package = apps.get_model("core", "Package")
    Package.objects.update(is_active=False)
    Package.objects.filter(name="arthexis").update(is_active=True)
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(activate_default_package, migrations.RunPython.noop),
    ]
